DROP TABLE IF EXIST laptops CASCADE;
DROP TABLE IF EXIST ads CASCADE;
DROP TABLE IF EXIST laptop_images CASCADE;
DROP TABLE IF EXIST users CASCADE;
DROP TABLE IF EXIST user_favorites CASCADE;
DROP TABLE IF EXIST messages CASCADE;
DROP TABLE IF EXIST chats CASCADE;
DROP TABLE IF EXIST chat_members CASCADE;
